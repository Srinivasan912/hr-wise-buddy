...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "TechnoHR — HRMS & Payroll for India" },
      ...
      { property: "og:title", content: "TechnoHR — HRMS & Payroll for India" },
      { name: "twitter:title", content: "TechnoHR — HRMS & Payroll for India" },
